...
function makeTempDir() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'token-monitor-chunked-log-'));
}
...
test('scanFileBatch returns a Promise, enforces a byte budget, and resumes without duplicates', async () => {
